...
function ManagerHomePage() {
  ...
  return (
    <div>
      ...
      <div className="flex gap-3 flex-col justify-center p-8 items-center lg:flex-row lg:items-start">
        <div className="flex w-full justify-start items-start lg:mt-7 lg:flex-col lg:justify-center lg:items-center lg:w-[30vw] p-5  shadow-xl bg-secondary  rounded-lg  h-fit  ">
